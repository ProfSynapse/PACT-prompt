...
Apply the S5 Decision Framing Protocol (see `pact-protocols.md`) when presenting algedonic signals:
...
**Any agent** can emit algedonic signals when they recognize trigger conditions. This is part of the Autonomy Charter (see `pact-agent-protocols.md`).
