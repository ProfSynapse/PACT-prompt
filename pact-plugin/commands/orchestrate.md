...
Before running orchestration, assess task variety using the protocol in @protocols/pact-variety.md.
...
See @protocols/pact-documentation.md for Orchestration Decision Log format templates.
...
- [ ] **S4 Checkpoint** (see @protocols/pact-s4-checkpoints.md): Environment stable? Model aligned? Plan viable?
...
See @protocols/pact-s2-coordination.md for S2 Coordination Layer protocol.
...
See @protocols/pact-s3-audit.md for S3* Continuous Audit protocol.
