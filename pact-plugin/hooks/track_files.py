...
def main():
    ...
    try:
        ...
        # THIRD JOB: record a teammate's background Bash launch — a frame
        ...
        # fault there cannot take down the two jobs above — file tracking is
        # this hook's contract and must survive anything that happens in the
        # registry write.
        #
