...
- `protocols/pact-protocols.md` - Coordination protocols
- `protocols/algedonic.md` - Emergency signal protocol
- `reference/vsm-glossary.md` - VSM terminology in PACT context
