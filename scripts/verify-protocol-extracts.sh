...
verify "pact-s1-autonomy.md" "S1 Autonomy (lines 517-590)" "517,590"
verify "pact-task-hierarchy.md" "Task Hierarchy (lines 635-723)" "635,723"
verify "pact-variety.md" "Variety (lines 725-786)" "725,786"

# Combined-range extracts
verify "pact-s2-coordination.md" "S2 Coordination (lines 365-516 + 941-955)" "365,516" "941,955"
verify "pact-workflows.md" "Workflows (lines 787-929)" "787,929"
verify "pact-phase-transitions.md" "Phase Transitions (lines 930-940 + 956-1033)" "930,940" "956,1033"
verify "pact-documentation.md" "Documentation (lines 1034-1058)" "1034,1058"
