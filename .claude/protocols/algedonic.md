...
Apply the S5 Decision Framing Protocol (see @~/.claude/protocols/pact-s5-policy.md) when presenting algedonic signals:
...
**Any agent** can emit algedonic signals when they recognize trigger conditions. This is part of the Autonomy Charter (see @~/.claude/protocols/pact-s1-autonomy.md).
