...
**Nested PACT**: For complex sub-systems, you may run a mini architecture cycle. Declare it, execute it, integrate results. Max nesting: 2 levels. See @~/.claude/protocols/pact-agent-protocols.md for S1 Autonomy & Recursion rules.
